...
const PROMOTIONS = [
  {
    title: 'May 2026 Monthly Promotions',
    slug: 'club-wide-may-2026-monthly-overview',
    summary: 'A round-up of this month\'s dining specials across the Club — flip through each venue below.',
    restaurantTag: 'club-wide',
    imageFiles: ['club-wide-may-2026-monthly-overview.jpg'],
    ctas: [],
    order: 1,
  },
  {
    title: 'A Sweet Treat for Mom',
    slug: 'central-a-sweet-treat-for-mom',
    summary: 'Celebrate Mom with a hand-crafted bundle of pastries and a custom cake from Central.',
    restaurantTag: 'central',
    imageFiles: ['central-a-sweet-treat-for-mom.jpg'],
    ctas: [],
    order: 2,
  },
  {
  ...
  {
    title: 'Grillhouse Monthly Special',
    slug: 'grillhouse-monthly-special',
    summary: 'This month\'s featured plate at Grillhouse — ask your server for details.',
    restaurantTag: 'grillhouse',
    imageFiles: ['grillhouse-monthly-special.jpg'],
    ctas: [],
    order: 5,
  },
  {
  ...
  {
    title: 'The 2nd Floor Monthly Special',
    slug: 'the-2nd-floor-monthly-special',
    summary: 'This month\'s featured dish at The 2nd Floor — ask your server for details.',
    restaurantTag: 'the-2nd-floor',
    imageFiles: ['the-2nd-floor-monthly-special.jpg'],
    ctas: [],
    order: 8,
  },
  {
    title: 'Surf & Turf Platter for Mom',
    slug: 'tradewinds-surf-and-turf-platter-for-mom',
    summary: 'A surf-and-turf set built for sharing — perfect for a Mother\'s Day lunch at Tradewinds.',
    restaurantTag: 'tradewinds',
    imageFiles: ['tradewinds-surf-and-turf-platter-for-mom.jpg'],
    ctas: [],
    order: 9,
  },
  {
  ...
  {
    title: 'Tradewinds Seasonal Highlights',
    slug: 'tradewinds-seasonal-highlights',
    summary: 'A rotating selection of seasonal dishes and drinks at Tradewinds.',
    restaurantTag: 'tradewinds',
    imageFiles: ['tradewinds-monthly-special-jan.jpg', 'tradewinds-monthly-special-oct.jpg'],
    ctas: [],
    order: 11,
  },
  {
