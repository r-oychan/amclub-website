...
async function upsertEventSpacesPage({ media }) {
  const data = {
    ...
    offsiteCatering: {
      ...
      ctas: [
        { label: 'Enquire Now', href: 'mailto:catering@amclub.org.sg', variant: 'primary', isExternal: true },
      ],
      pillars: [
        {
      ...
      subBanner: {
        ...
        cta: { label: 'Order Now', href: 'https://amclub.jotform.com/252803081876966', variant: 'primary', isExternal: true },
      },
    },
    finalCta: {
