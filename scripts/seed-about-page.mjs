...
const IMAGES = [
  ...
  'advocacy-aside.png',
  // management 6
  'mgmt-christine.jpeg', 'mgmt-michael-collins.jpg', 'mgmt-audrey.jpeg',
  'mgmt-chang.jpg', 'mgmt-vincent.jpg', 'mgmt-julia-tan.jpg', 'mgmt-julie.jpg',
...
const COMMITTEE = [
  ...
  ['Michael Collins', 'Head of Culinary',                   'mgmt-michael-collins.jpg', 'management', 2,
    "Michael Collins is a seasoned culinary executive with more than 30 years of leadership experience across Five-Star resorts, luxury hotels, private clubs, and boutique destinations, including 14 years working in Texas. Raised in California, he is recognized for his ability to envision, develop, and transform food and beverage programs through strategic concept development, pre-opening and rebranding leadership, and disciplined operational execution.\n\nThroughout his career, Michael has led new-build and destination openings and held senior roles at premier properties including JL Bar Ranch Resort & Spa, The Hilton San Antonio, The Windsor Court Hotel, and The Meritage Resort & Spa. Most recently, he played a key role in a property's re-opening and rebranding, strengthening culinary direction and operational strategy to deliver refined, guest-centric dining experiences.\n\nA collaborative and visionary leader, Michael brings deep expertise in menu engineering, kitchen operations, procurement, P&L management, team development, and multi-outlet operations, consistently driving elevated guest experiences and strong business performance."],
  ['Audrey Lim',   'Director of Finance',                   'mgmt-audrey.jpeg',  'management', 3,
    "Audrey oversees the Club's accounts, store, payroll, and purchasing functions. With over 20 years of experience in finance within the hospitality industry, she excels in project management from conceptualization to execution, focusing on driving efficiencies through job redesign and automation. In her recent roles, she was instrumental in piloting and implementing a paperless workflow system, which, after national success, is set for regional rollout.\n\nAs a collaborative leader, Audrey aims to partner with the team and General Committee to enhance the Club's profitability and cash flow management by leveraging systems and automation to achieve the overall goals and vision of the Club."],
  ['Chang Lim',    'Director of Information Technology',    'mgmt-chang.jpg',    'management', 4,
    "Chang is a seasoned technology professional with over 20 years of experience. He began his career in the United States, spending 12 years at General Electric, where he developed a strong foundation in IT and Finance. Driven by a desire to broaden his impact and to be closer to his family, Chang moved to Singapore to continue his career growth, bringing a wealth of international experience to the region.\n\nOver the past 13 years, he has focused on the Hospitality, Tourism and Gaming industries, leading digital transformation initiatives and implementing technology-driven strategies to improve productivity. Chang looks forward in bringing his passion to The American Club, focusing on enhancing the Members experience and driving productivity among Team Members."],
  ['Vincent Lim',  'Director of Human Resources',           'mgmt-vincent.jpg',  'management', 5,
    "Vincent oversees the Club's Human Resource department, encompassing Compensation & Benefits, Talent Attraction & Retention, Talent Management & Development, and Team Member Engagement. He brings over 20 years of experience in human resources within the hospitality industry to his new role at the Club. In his most recent position, Vincent played a key role in the pre-opening team that successfully rebranded a property, leading to them securing #2 spot in Singapore's Great Place to Work rankings for two consecutive years, 2022 and 2023.\n\nVincent believes that teamwork and transparent communication are the foundations of a successful organization. As a collaborative leader, he is dedicated to enhancing Team Members' working experience, fostering a positive workplace culture, and supporting personal career development for all employees."],
  ['Julia Tan',    'Director of Membership & Marketing',    'mgmt-julia-tan.jpg', 'management', 6,
    "Julia Tan leads the Club's membership acquisition and partnership initiatives, while also enhancing the Club's brand and visibility. With a career spanning publishing, technology, and nonprofit leadership, Julia brings a thoughtful, relationship-driven approach to building communities and delivering high-quality member experiences. Earlier in her career, she worked with global education publishers, including Pearson and Thomson Learning, contributing to the development of innovative digital learning and assessment platforms. She then moved into business development within the Silicon Valley technology sector.\n\nNow based in Singapore, is deeply committed to fostering connection, belonging, and engagement within member-based organizations. Her diverse leadership and volunteer roles across international communities and schools have honed her ability to combine strategic thinking with warmth, approachability, and cultural sensitivity. Most recently, she served as President of the American Women's Association. Driven by a passion for community-building, member experience, and communication, Julia is dedicated to ensuring that The American Club remains a welcoming home away from home for its Members and families"],
  ['Julie Zul',    'Director of Member Engagement',         'mgmt-julie.jpg',    'management', 7,
    "Julie is in charge of overseeing and managing the Member engagement and banquet & catering functions of the Club. This includes maintaining the Club's reputation as a premier destination for an enriching and enjoyable membership experience, ensuring that all events, from intimate gatherings to large-scale functions, are executed flawlessly.\n\nSome of her accomplishments include establishing the CARE (Creating A Right Environment) Program – a training program that helps equip our Team Members with the skills and competencies to mentor their junior colleagues.\n\nJulie brings with her a long experience from the airline industry. She was a former flight attendant and cabin crew trainer with Silkair where she has mastered the art of service excellence and training teams."],
];

const HERITAGE_SLIDES = [
  ['1932', 'The idea of forming a social club for Americans was first introduced in 1932 by the American Association of Malaya. As the total of 56 Americans residing in Singapore was insufficient to support the proposed club, the plan was put on hold.', 'heritage-1932.jpg'],
