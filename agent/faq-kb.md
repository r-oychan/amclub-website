<!-- GENERATED from reference/TAC_Master_FAQ_Repository.xlsx (draft answers; none approved yet).
     This is the "manual:faq-master-repository" knowledge-base document uploaded to the ElevenLabs
     agents (dev on the agency account; uat + prod on the Club account). Each Q&A carries a Source
     line so RAG chunks retain a citable page URL. Regenerate + re-upload when the FAQ changes. -->
...
Source: [Start Application](https://amclub.org.sg/membership/start-application)
...
Source: [Reciprocal Clubs](https://amclub.org.sg/membership/reciprocal-clubs)
...
### Can I bring guests to dine with me?
