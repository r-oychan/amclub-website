...
export interface ApiAdvertiseWithUsPageAdvertiseWithUsPage
...
export interface ApiEventSpacesPageEventSpacesPage
  extends Struct.SingleTypeSchema {
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locationHref: Schema.Attribute.String;
...
export interface ApiFacilityFacility extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Club facilities (fitness, kids, event spaces)';
...
export interface ApiFitnessFacilityFitnessFacility
  extends Struct.CollectionTypeSchema {
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images'>;
    navItems: Schema.Attribute.Component<'shared.nav-dropdown', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiKidsExperienceKidsExperience
  extends Struct.CollectionTypeSchema {
...
export interface ApiNicheGroupMembershipPageNicheGroupMembershipPage
  extends Struct.SingleTypeSchema {
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'memberName'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVenueVenue extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Event venue spaces';
    displayName: 'Venue';
    pluralName: 'venues';
    singularName: 'venue';
  };
...
export interface ApiWhatsOnPageWhatsOnPage extends Struct.SingleTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::fitness-facility.fitness-facility': ApiFitnessFacilityFitnessFacility;
      ...
      'api::kids-experience.kids-experience': ApiKidsExperienceKidsExperience;
