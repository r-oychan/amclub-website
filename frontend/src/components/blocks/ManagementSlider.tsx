    ...
    <section className="relative bg-primary text-white py-16 md:py-24 overflow-hidden">
      {watermark && (
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none select-none absolute -bottom-10 -left-10 w-[420px] opacity-[0.06]"
        />
      )}
      ...
      <div className="relative max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-10 lg:gap-16 items-start">
          ...
          <div className="lg:max-w-[500px]">
            ...
            {m.bio && (
              <div className="font-body text-white/85 leading-relaxed whitespace-pre-line space-y-4">
                {m.bio.split(/\n\n+/).map((para, i) => (
                  <p key={i}>{para}</p>
                ))}
              </div>
          ...
          <div className="relative">
            ...
            {members.length > 1 && (
              <button
                ...
                className="absolute z-10 flex items-center justify-center rounded-full text-white hover:opacity-100 transition"
                style={{
                  right: -16,
                  top: '50%',
        ...
        {members.length > 1 && (
          <div className="mt-10 flex items-center justify-center gap-2">
            <button
              ...
              className="hidden md:inline-flex items-center justify-center w-8 h-8 rounded-full text-white/70 hover:text-white transition mr-2"
            >
            ...
            <button
              ...
              onClick={next}
              aria-label="Next director"
              className="hidden md:inline-flex items-center justify-center w-8 h-8 rounded-full text-white/70 hover:text-white transition ml-2"
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <polyline points="9,18 15,12 9,6" />
              </svg>
